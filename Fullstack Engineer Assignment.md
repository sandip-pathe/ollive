...
Create a lightweight SDK, middleware, or wrapper around your LLM calls that captures
inference metadata.
...
The SDK should send logs to an ingestion endpoint in near real time. Implementation details
are flexible.
